...
// Reviews data (typically this would come from a database or external file)
$jsonData = '[
  {
    "name": "Ravi Patel",
...
<head>
  ...
  <style>
    .swiper-pagination { width: 100%; text-align: center; padding-top: 12px; margin-top: 32px; margin-bottom: 8px; position: static !important; }
    .swiper-pagination-bullet { width: 12px; height: 12px; background-color: #1E3A8A; opacity: 0.4; margin: 0 6px !important; transition: opacity 0.3s ease, transform 0.3s ease; }
