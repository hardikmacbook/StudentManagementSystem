    ...
    ?>
      <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
        ...
        <div class="p-6">
          ...
          <a href="course_years.php?id=<?php echo $course['id']; ?>" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded transition duration-300">View Course</a>
        </div>
      </div>
    <?php } ?>
  </div>
